    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {product.etsyUrl && (
        <a
          ...
          className="flex items-center justify-center gap-2.5 w-full py-4 bg-[#8b5a35] hover:bg-[#5d3923] text-white rounded-[4px] font-medium text-base transition-all duration-200 shadow-xs focus-ring"
        >
      ...
      {product.ebayUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer sponsored nofollow"
          className="flex items-center justify-center gap-2.5 w-full py-3.5 bg-white hover:bg-[#f8f6f2] text-[#1c1a17] border border-[#ded7ce] hover:border-[#1c1a17] rounded-[4px] font-medium text-sm transition-all duration-200 focus-ring"
        >
          <span>Purchase on eBay (Direct Listing)</span>
          <ArrowUpRight className="w-4 h-4" />
